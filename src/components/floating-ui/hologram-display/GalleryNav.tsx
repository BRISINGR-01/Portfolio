...
export default function GalleryNav({
	...
	function next() {
		onSelect(currentPage === nrOfPages - 1 ? 0 : currentPage + 1);
	}
	function prev() {
		onSelect(currentPage === 0 ? nrOfPages - 1 : currentPage - 1);
	}
	...
	return (
		...
		>
			...
			>
				<div className="pointer navArrow" onClick={prev} style={{ color: COLOR_PALETTE.PRIMARY }}>
					‹
				</div>
				...
				<div className="pointer navArrow" onClick={next} style={{ color: COLOR_PALETTE.PRIMARY }}>
					›
				</div>
			</Stack>
		</FadeAnim>
