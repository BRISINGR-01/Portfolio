...
import { TRANSITION, type WorkingExperience } from "../../constants";
import { parseTimeSpan, useIcon } from "../../utils";
import G_Card from "./Card.tsx";

function ChangeAnimation(props: { id: string; children: React.JSX.Element | React.JSX.Element[] }) {
	return (
		<motion.span
			key={props.id}
...
export default function IntenshipsAndBigProjects({ data }: { data: WorkingExperience | null }) {
	const icons = useIcon();
